...
public class OptionalExpression extends AbstractCompilableMatcher implements CompilableMatcher {

  private final CompilableMatcher subExpression;

  public OptionalExpression(CompilableMatcher subExpression) {
  ...
  public Instr[] compile() {
    Instr[] instr = subExpression.compile();
