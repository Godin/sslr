...
public class ZeroOrMoreExpressionTest {
  ...
  public void test() {
    ...
    Instr[] instructions = Instr.appendEnd(new ZeroOrMoreExpression(a).compile());
  ...
  public void should_check_that_moves_forward() {
    CompilableMatcher subExpression = new OptionalExpression(new CharExpression('a'));
    Instr[] instructions = Instr.appendEnd(new ZeroOrMoreExpression(subExpression).compile());
